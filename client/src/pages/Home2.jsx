                ...
                <div className="left">
                    ...
                    <div className="students-already-enrolled">
                        <div className="student">
                            <img src="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instructor-1/v7fki8c2z311e5d7zh3s" alt="" />
                        </div>
                        <div className="student">
                            <img src="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instrutor-2/p4ea67miz9lqloryusyb" alt="" />
                        </div>
                        <div className="student">
                            <img src="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instructor-4/ui0ohukjrfxuej2inebe" alt="" />
                        </div>
                        {/* <div className="student">
            ...
            <div className="page2">
                ...
                <div className='features'>
                    <div className="feature" onClick={() => navigate('/instructor')}>
                        ...
                        <h4>Instructors</h4>
                        <p>Learn directly from expert instructors who have real industry knowledge.
Get guidance, insights, and mentorship — not just theory.</p>
                    </div>
                    <div className="feature" onClick={() => navigate('/course')}>
                        <img src="/assets/course.png" alt="" />
                        <h4>Courses</h4>
                        <p>Explore our curated courses designed to build real skills.
From fundamentals to advanced topics — learn step by step at your own pace.</p>
                    </div>
                    <div className="feature" onClick={() => navigate('/video')}>
                        <img src="/assets/video.png" alt="" />
                        <h4>Video Lectures</h4>
                        <p>High-quality video lectures that explain concepts clearly and visually.
No more confusion — understand topics the smart way.</p>
                    </div>
                    <div className="feature" onClick={() => navigate('/doubt-corner')}>
                        <img src="/assets/doubt.png" alt="" />
                        <h4>Doubt Corner</h4>
                        <p>Stuck somewhere?
Ask your questions anytime and get clarity.
Learning shouldn’t stop because of doubts.</p>
                    </div>
                    <div className="feature" onClick={() => navigate('/exam-corner')}>
                        <img src="/assets/exam.png" alt="" />
                        <h4>Exam Corner</h4>
                        <p>Practice quizzes, mock exams, and assessments to test your understanding.
Track your progress and prepare for real-world challenges with confidence.</p>
                    </div>
                </div>
            </div>
            {/* <div className="page3">
            ...
            <div className="page3">
                ...
                <div className='videos'>
                    <div className="video">
                        <VideoCard
                            id="690d9417b4385c5ee2ebdf01"
                            title="C++ — Complete Programming"
                            description={"vid.description"}
                            duration={"18 m"}
                            thumbnail={"https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762495770/eogdylalyax3powfmmjj.png"}
                            profileImage="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instructor-1/v7fki8c2z311e5d7zh3s"
                        />
                    </div>
                    <div className="video">
                        <VideoCard
                            id="690d9349b4385c5ee2ebde7d"
                            title="Java — Complete Programming"
                            description={"vid.description"}
                            duration={"18 m"}
                            thumbnail={"https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762495069/savepxmu7rtcpszu2nng.webp"}
                            profileImage="https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762493940/ui0ohukjrfxuej2inebe.png"
                        />
                    </div>
                    <div className="video">
                        <VideoCard
                            id="690d914cb4385c5ee2ebddc4"
                            title="MongoDB — Complete NoSQL Database Course"
                            description={"vid.description"}
                            duration={"18 m"}
                            thumbnail={"https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762496844/zyhoflgmgmb5zgqnwol9.jpg"}
                            profileImage="https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762493163/p4ea67miz9lqloryusyb.png"
                        />
                    </div>
                </div>
            </div>
            <div className="page4">
                ...
                <div className='courses-list'>
                    <div className='courses'>
                        <Link to='/course/690d7892b4385c5ee2ebd943' >
                            <Card
                                key={'690d7892b4385c5ee2ebd943'}
                                sx={{ width: "100%", overflow: "hidden" }}
                            >
                                <CardMedia
                                    sx={{ width: "100%", aspectRatio: "2/1" }}
                                    image='https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762502922/nextjs_logo_muwmkx.webp'
                                ...
                                <CardContent className='box'>
                                    ...
                                    <Typography variant="body2" color="text.secondary" className='desc'>
                                        {filterDesc("Learn how to build modern, fast, and SEO-friendly web apps using the Next.js framework — from routing to backend APIs.")}
                                    </Typography>
                                    <div className='tags'>
                    ...
                    <div className='courses'>
                        <Link to='/course/690d8fe6b4385c5ee2ebdd72' >
                            <Card
                                key={'690d8fe6b4385c5ee2ebdd72'}
                                sx={{ width: "100%", overflow: "hidden" }}
                            >
                                <CardMedia
                                    sx={{ width: "100%", aspectRatio: "2/1" }}
                                    image='https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762502802/mongodb_logo_gfwm9v.png'
                                ...
                                <CardContent className='box'>
                                    ...
                                    <span className='level'>intermediate</span>
                                    <Typography variant="body2" color="text.secondary" className='desc'>
                                        {filterDesc("Master the NoSQL world with MongoDB — learn collections, CRUD, indexing, schema design and aggregation pipelines.")}
                                    </Typography>
                                    <div className='tags'>
                                        <Fab variant="extended" size="small" className='tag'>
                                            coding
                    ...
                    <div className='courses'>
                        <Link to='/course/690d782ab4385c5ee2ebd930' >
                            <Card
                                key={'690d782ab4385c5ee2ebd930'}
                                sx={{ width: "100%", overflow: "hidden" }}
                            >
                                <CardMedia
                                    sx={{ width: "100%", aspectRatio: "2/1" }}
                                    image='https://res.cloudinary.com/dmi3gyqoo/image/upload/v1762502871/cpp-programming_ddk2ho.jpg'
                                ...
                                <CardContent className='box'>
                                    ...
                                    <span className='level'>intermediate</span>
                                    <Typography variant="body2" color="text.secondary" className='desc'>
                                        {filterDesc("Learn C++ from scratch — from fundamentals to OOP and STL — perfect for DSA, placements, and competitive programming.")}
                                    </Typography>
                                    <div className='tags'>
                                        <Fab variant="extended" size="small" className='tag'>
                                            coding
            ...
            <div className="page5">
                ...
                <div className="teachers">
                    <div className='teachercards'>
                        <TeacherCard
                            id="690cfe91eb0ab2f795413d17"
                            username="Keshava"
                            profileImage="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instructor-1/v7fki8c2z311e5d7zh3s"
                            socialMediaLinks={{linkedin : "https://www.linkedin.com/in/keshava-k07/", twitter : "https://x.com/kesavak14588226"}}
                        />
                        <TeacherCard
                            id="65b544fcba3120d84f3365e9"
                            username="Heman"
                            profileImage="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instrutor-2/p4ea67miz9lqloryusyb"                       
                            socialMediaLinks={{linkedin : "https://www.linkedin.com/in/hemannarayanan/", twitter: "https://x.com/"}}
                        />
                        <TeacherCard
                            id="65a2bf4f78312d451db95325"
                            username="Samhitha"
                            profileImage="https://res.cloudinary.com/dmi3gyqoo/image/upload/t_instructor-4/ui0ohukjrfxuej2inebe"
                            socialMediaLinks={{linkedin : "https://www.linkedin.com/in/samhitha-vallabhaneni/", twitter: "https://x.com/"}}
                        />
                    </div>
                </div>
            </div>
            <div className="footer">
                Copyright ©2025-2026 Learnyard, Inc. All rights reserved.
                <p> - Powered by <b>Learnyard Team</b></p>
            </div>
        </Container>
    )
}
