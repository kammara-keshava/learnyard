      ...
      <div className="container-footer">
        <div className="upper-part">
          <div className="about-section">
            ...
            <b>Learnyard</b> is a ed - tech website with amazing doubt posting/solving and teacher-student interaction features
            </p>
            ...
            <p style={{"text-align":"left"}}>
              <i className="fa fa fa-envelope"></i> learnyard@gmail.com
            </p>
            <p style={{"text-align":"left"}}>
              For Contribution <a href='https://github.com/kammara-keshava/learnyard' style={{"color":"black","textDecoration":"none"}} target="_blank">Link</a>
            </p>
          </div>
