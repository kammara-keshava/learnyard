...
const connectionParams = {
  ...
  // The following TLS options are added for diagnosis. Remove tlsAllowInvalidCertificates
  // in production — it disables certificate validation.
  tls: true,
  // For local / network troubleshooting you can allow invalid certs temporarily.
  // If this fixes the error, prefer fixing the network/CA rather than keeping this.
  tlsAllowInvalidCertificates: true,
  serverSelectionTimeoutMS: 10000, // fail faster if server is unreachable
};
